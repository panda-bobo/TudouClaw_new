---
name: superpowers-engineering
description: "Engineering workflow pack — combined planning, implementation, review, and shipping skills (vendored from obra/superpowers, merged 2026-05-04). Use this when working on any non-trivial dev task: brainstorm → plan → implement (TDD) → debug/verify/review → finish branch."
applicable_roles:
  - "coder"
  - "architect"
  - "reviewer"
...
scenarios:
  ...
  - "测试驱动"
metadata:
  source: obra/superpowers (merged)
  license: MIT
  upstream: https://github.com/obra/superpowers
  merged_skills: 12
  merge_note: "Original 12 split skills archived under .legacy_split/ — see MANIFEST.yaml history for the per-skill granularity."
---
